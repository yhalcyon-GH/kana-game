...
- **[autonomous-operations.md](./autonomous-operations.md)** — multi-task autonomous/"Overnight mode" loop, Stop/Human Gates, and recovery; layered on top of the docs above without loosening any gate.
