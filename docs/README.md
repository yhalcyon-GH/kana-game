...
- **[security/security-hardening-tranche-2.md](./security/security-hardening-tranche-2.md)** — version-pinned dependency lifecycle-script policy, fail-closed Production auth API origin, and PHPStan PHP SAST added without Composer.
