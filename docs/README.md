...
- **[security/security-audit-v1.md](./security/security-audit-v1.md)** — 2026-09-20 repository-wide Security & Safety Audit v1: findings, merged remediations, Production read-only evidence, residual risks, and remaining Human Actions.
- **[security/threat-model-v1.md](./security/threat-model-v1.md)** — Tamamizu security assets, trust boundaries, threat actors, core invariants, abuse cases, and re-audit triggers.
