...
- **[2026-08-15-content-categories-session.md](./2026-08-15-content-categories-session.md)** — end-of-session report for the katakana/sokuon/chōon/yōon/特殊音 content rollout (5 branches off `main`, each off the previous, none merged yet).
- **[2026-08-15-voice-quality-check-design.md](./2026-08-15-voice-quality-check-design.md)** — design (approved, not yet implemented) for automated Japanese voice-quality checking (mispronunciation detection via local ASR, PASS/WARNING/FAIL workflow). Phase 1 only; F0/accent analysis and a dev review screen are deferred future phases.
