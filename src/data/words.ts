...
export const WORDS_BY_ROW: Record<string, AnchorWord[]> = {
  ...
  'sokuon-row': [
    ...
    { id: 'sokuon-kako', kana: 'かこ', romaji: 'kako', meaning: 'the past', characterIds: ['ka', 'ko'] },
    ...
    { id: 'sokuon-machi', kana: 'まち', romaji: 'machi', meaning: 'town', characterIds: ['ma', 'chi'] },
  ...
  'chouon-o-row': [
    { id: 'chouon-o-otouto', kana: 'おとうと', romaji: 'otouto', meaning: 'younger brother', characterIds: ['o', 'to', 'u', 'to'] },
