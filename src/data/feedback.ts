...
// memory), one clip per line at public/audio/feedback/<id>.wav. Exactly nine
// lines total; see lib/feedbackVoice.ts for when each one plays.
...
export const OSHII: FeedbackLine = { id: 'oshii', text: 'おしい' } // near-miss wrong answer / eval screen: 1-2 mistakes
