...
const REAL_ROWS: GojuonRow[] = [
  ...
  // ta-row/ha-row already do for the base gojūon.
  {
    ...
    displayLines: ['きゃ・きゅ・きょ', 'ぎゃ・ぎゅ・ぎょ'],
    order: 0,
  ...
  },
  {
    ...
    displayLines: ['しゃ・しゅ・しょ', 'じゃ・じゅ・じょ'],
    order: 1,
  ...
  },
  {
    ...
    displayLines: ['ちゃ・ちゅ・ちょ', 'にゃ・にゅ・にょ'],
    order: 2,
  ...
  },
  {
    ...
    displayLines: ['ひゃ・ひゅ・ひょ', 'びゃ・びゅ・びょ', 'ぴゃ・ぴゅ・ぴょ'],
    order: 3,
  ...
  },
  {
    ...
    displayLines: ['みゃ・みゅ・みょ', 'りゃ・りゅ・りょ'],
    order: 4,
  ...
  },
  {
    ...
    displayLines: ['キャ・キュ・キョ', 'ギャ・ギュ・ギョ'],
    order: 5,
  ...
  },
  {
    ...
    displayLines: ['シャ・シュ・ショ', 'ジャ・ジュ・ジョ'],
    order: 6,
  ...
  },
  {
    ...
    displayLines: ['チャ・チュ・チョ', 'ニャ・ニュ・ニョ'],
    order: 7,
  ...
  },
  {
    ...
    displayLines: ['ヒャ・ヒュ・ヒョ', 'ビャ・ビュ・ビョ', 'ピャ・ピュ・ピョ'],
    order: 8,
    characterIds: [
  ...
  },
  {
    ...
    displayLines: ['ミャ・ミュ・ミョ', 'リャ・リュ・リョ'],
    order: 9,
