...
describe('progressStore', () => {
  ...
  describe('v15 -> v16 hasCompletedYouonGuide migration (Issue #50)', () => {
    it('defaults an existing user to false (shown the next time they open the first Yōon lesson)', async () => {
